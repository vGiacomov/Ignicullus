...
function KpiCard({ label, value, unit, ok, warn }:
  ...
  return (
    <div style={{ background:'#161b22', border:'1px solid #21262d', borderRadius:10,
      ...
      <div style={{ fontSize:'0.62rem', color:'#8b949e', letterSpacing:'0.18em',
        textTransform:'uppercase', fontFamily:'var(--font-mono)', marginBottom:6 }}>{label}</div>
    ...
    <div style={{ marginBottom:16 }}>
      <div style={{ display:'flex', justifyContent:'space-between', marginBottom:4 }}>
        ...
        <span style={{ fontFamily:'var(--font-mono)', fontSize:'0.78rem',
          color:'#f0a500', fontWeight:600 }}>{value} {unit}</span>
      </div>
...
export default function PreLaunchPage() {
  ...
  return (
    <div style={{ padding:'32px 40px', maxWidth:1100 }}>
      {/* Header */}
      <div style={{ fontFamily:'var(--font-hud)', fontSize:'1.5rem', fontWeight:900,
        color:'#f0a500', letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:6 }}>
        ⚙️ Pre-Launch Configuration
      </div>
      <div style={{ fontSize:'0.72rem', color:'#8b949e', fontFamily:'var(--font-mono)',
      ...
      {tab === 0 && (
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:24 }}>
          <div style={{ background:'#161b22', border:'1px solid #21262d',
            ...
            <div style={{ fontSize:'0.7rem', color:'#f0a500', fontFamily:'var(--font-mono)',
          ...
          <div style={{ background:'#161b22', border:'1px solid #21262d',
            borderRadius:12, padding:'20px 24px' }}>
            <div style={{ fontSize:'0.7rem', color:'#58a6ff', fontFamily:'var(--font-mono)',
              letterSpacing:'0.15em', textTransform:'uppercase', marginBottom:16 }}>
              🔵 Stage 2 — Upper Stage
            </div>
          ...
          <div style={{ background:'#161b22', border:'1px solid #21262d',
            borderRadius:12, padding:'20px 24px', gridColumn:'1/-1' }}>
            <div style={{ fontSize:'0.7rem', color:'#bc8cff', fontFamily:'var(--font-mono)',
              letterSpacing:'0.15em', textTransform:'uppercase', marginBottom:16 }}>
            ...
            {[
              ...
              <div key={lbl as string} style={{ display:'flex', justifyContent:'space-between',
                ...
                <span style={{ fontFamily:'var(--font-mono)', fontSize:'0.8rem',
                  color: ok ? '#00c896' : '#ff4444' }}>{val}</span>
              </div>
            ))}
            <div style={{ marginTop:16, padding:'12px', borderRadius:8,
      ...
      {tab === 2 && (
        <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr', gap:24 }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
            <div style={{ background:'#161b22', border:`1px solid ${score>=90?'#00c896':score>=70?'#f0a500':'#ff4444'}40`,
              borderRadius:12, padding:'24px', textAlign:'center' }}>
              <div style={{ fontFamily:'var(--font-hud)', fontSize:'3rem', fontWeight:900,
              ...
              <div style={{ marginTop:16, fontSize:'0.78rem', fontFamily:'var(--font-mono)',
                color: score>=90 ? '#00c896' : score>=70 ? '#f0a500' : '#ff4444' }}>
